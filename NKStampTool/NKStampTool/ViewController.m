...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    [picker dismissViewControllerAnimated:YES completion:^(void){
        //加工画面へ
        NKEditController *oNKEditController = [[NKEditController alloc] initWithBackgroundImage:image];
        [self.navigationController pushViewController:oNKEditController animated:YES];
    }];
}
